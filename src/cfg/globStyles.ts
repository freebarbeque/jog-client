...
// Colors
///////////////////////
export const PURPLE = '#181E3A';
export const PINK = '#FF3F5C';
export const WHITE = '#FFF';
export const GREY = '#5B6074';
export const CREME = '#F4F0E6';
export const LIGHT_GREY = '#F0F1F2';
export const GREY_SETTINGS_BG = '#BFBEBF';
///////////////////////
// Images
///////////////////////
export const LOGO = require('../../img/logo.png');
export const LANDING_TITLE_BG = require('../../img/landing_bg.png');
export const RIGHT_ARROW = require('../../img/right_arrow.png');
