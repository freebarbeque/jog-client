...
export const formSelectLabelStyle = {
  height: 40,
  lineHeight: 40,
  paddingRight: 40
};

export const formSelectIconStyle = {
  width: 40,
  height: 40,
  padding: 8
};
...
export const SET_ADDRESS_SUBMIT_ERROR = 'userDetails/SET_ADDRESS_SUBMIT_ERROR';
...
export const STORE_VEHICLE_LOCALLY = 'userDetails/STORE_VEHICLE_LOCALLY';
