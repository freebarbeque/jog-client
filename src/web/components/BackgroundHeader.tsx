...
import { Arrow, Chevron } from 'src/web/images/index';

// tslint:disable-next-line:no-var-requires
const background = require('src/web/images/background2.png');
...
class BackgroundHeader extends React.Component<IConnectedBackgroundHeaderProps, {}> {
