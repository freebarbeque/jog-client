...
import { BLUE, WHITE, PINK, DARK_GRAY } from 'src/common/constants/palette';
...
const Button = styled.div`
    height: 40px;
    background-color: ${props => (props.checked ? PINK : '#dbdcde')};
    ...
    align-items: center;
    font-size: 16px;
    color: ${props => (props.checked ? WHITE : DARK_GRAY)};
`;
