...
import { Details, PolicyBots, Upload } from 'src/web/images/index';
import Jumbotron from 'src/web/components/Jumbotron'
import { max, min } from 'src/web/media';

// tslint:disable-next-line:no-var-requires
const background = require('src/static/background.png');
    ...
    public render() {
        return (
            <Container className="GetStartedScreen">
                ...
                <Button onClick={() => console.log('Will add policy')}>
