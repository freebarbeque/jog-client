...
import PolicyTabs from 'src/web/screens/Dashboard/components/PolicyTabs';
...
const quotes = [
    ...
    {logo: <Avatar2/>, price: 984.00, excess: 492, owner: 'admiral', extras: 4},
    {logo: <Avatar1/>, price: 1000.00, excess: 500, owner: 'Aviva', extras: 3},
    {logo: <Avatar2/>, price: 1200.00, excess: 600, owner: 'admiral', extras: 11},
    {logo: <Avatar1/>, price: 2000.00, excess: 1000, owner: 'Aviva', extras: 5},
];

const QuotesScreenAnnually = (props: any) => (
...
const StyledQuotesScreenAnnually = styled(QuotesScreenAnnually)`
    display: flex;
    flex-direction: column;
    flex: 1;
    align-self: stretch;
...
export default connect(null, mapDispatchToProps)(StyledQuotesScreenAnnually);