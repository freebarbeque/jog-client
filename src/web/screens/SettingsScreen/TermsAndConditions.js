  ...
  <Container>
    ...
    <p>
      <a href="http://www.joginsurance.com/">
        This terms of use (together with the documents referred to in it) tells
        you the terms of use on which you may make use of our website{' '}
      </a>www.joginsurance.com (<b>our app</b>), whether as a guest or a
      registered user. Use of our app includes accessing, browsing, downloading
      or registering to use our app.
    </p>
    <p>
      <br />
    </p>
    <p>
      Please read these terms of use carefully before you start to use our app,
      as these will apply to your use of our app. We recommend that you print a
      copy of this for future reference.
    </p>
    <p>
      <br />
    </p>
    <p>
      By using our app, you confirm that you accept these terms of use and that
      you agree to comply<span />with them<span>
    ...
    <ul>
      <li>
        <p>
          ...
          provide to us and information about the cookies on our app. By using
          our app, you consent to such processing and you warrant that all data
        ...
        <p>
          <a href="http://www.joginsurance.com/">www.joginsurance.com</a>
          <span />is a app operated by <b>POLICYJOG LTD </b>(<b>we </b>or{' '}
          <b>us</b>). We are a limited company registered in England and Wales
          under company number 10669783 and have our registered office at 48
          Gloucester Street, London SW1V 4EH.
        </p>
        <p>
          <br />
        </p>
        ...
        <h2>Changes to our app</h2>
        <p>
          We may update our app from time to time, and may change the content at
          any time. However, please note that any of the content on our app may
          be out of date at any given time, and we are under no obligation to
          update it. We do not guarantee that our app, or any content on it,
          will be free from errors or omissions.
        </p>
        <p>
          <br />
        </p>
        <h2>Accessing our app</h2>
        <p>
          Our app is made available free of charge. We do not guarantee that our
          app, or any content on it, will always be available or be
          uninterrupted. Access to our app is permitted on a temporary basis. We
          may suspend, withdraw, discontinue or change all or any part of our
          app without notice. We will not be liable to you if for any reason our
        ...
        <p>
          ...
          have access to our app. You are also responsible for ensuring that all
        ...
        <p>
          <a href="mailto:support@joginsurance.com">
            ...
            identification code or password, you must promptly notif
          </a>
          <a href="mailto:support@joginsurance.com">
        ...
        <p>
          ...
          in our app, and in the material published on it. Those works are
        ...
        <p>
          ...
          from our app for your personal use and you may draw the attention of
          others within your organisation to content posted on our app. You must
        ...
        <p>
          You must not use any part of the content on our app for commercial
        ...
        <p>
          If you print off, copy or download any part of our app in breach of
          these terms of use, your right to use our app will cease immediately
        ...
        <p>
          The content on our app is provided for general information only. It is
          ...
          from, any action on the basis of the content on our app.
        </p>
        <p>
          <br />
        </p>
        ...
        <p>
          ...
          representations or other terms which may apply to our app or any
        ...
        <ul>
          <li>
            <p>use of, or inability to use, our app; or</p>
          </li>
          <li>
            <p>use of or reliance on any content displayed on our app.</p>
            <p>
              <br />
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              app for domestic and private use. You agree not to use our app for
              any commercial or business purposes, and we have no liability to
            ...
            <p>
              ...
              our app or to your downloading of any content on them, or on any
            ...
            <p>
              ...
              our app. Such links should not be interpreted as endorsement by us
            ...
            <h2>Uploading content to our app</h2>
            <p>
              Whenever you make use of a feature that allows you to upload
              content to our app, or to make contact with other users of our
              app, you must comply with the content standards set out in our
            ...
            <p>
              Any content you upload to our app will be considered
              ...
              and other users of our app a limited licence to use, store and
            ...
            <p>
              ...
              to our app constitutes a violation of their intellectual property
            ...
            <p>
              We have the right to remove any posting you make on our app if, in
              our opinion, your post does not comply with the content standards
              set out in our Acceptable Use Policy (see below).
            </p>
            <p>
              The views expressed by other users on our app do not represent our
              views or values.
            </p>
            <p>
              <br />
          ...
          <li>
            <p>
              ...
              in contravention of the provisions of these terms of website use;
            </p>
          </li>
          <li>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>any equipment or network on which our app is stored;</p>
              </li>
              <li>
                <p>any software used in the provision of our app; or</p>
              </li>
              <li>
                <p>
                ...
                <p>
                  ...
                  app, for example, chat rooms and bulletin boards (“<b>Interactive Services</b>”).
                </p>
                <p>
                  <br />
                </p>
                <p>
                  ...
                  whether it is human or technical). We will do our best to
                  assess any possible risks for users (and in particular, for
                  children) from third parties when they use any Interactive
                  Service provided on our app, and we will decide in each case
                  whether it is appropriate to use moderation of the relevant
                  service (including what kind of moderation to use) in the
                  light of those risks. However, we are under no obligation to
                  oversee, monitor or moderate any Interactive Service we
                  provide on our app, and we expressly exclude our liability for
                  any loss or damage arising from the use of any interactive
                ...
                <p>
                  ...
                  you contribute to our app (<b>contributions</b>), and to any
                  interactive services associated with it. You must comply with
                  the spirit and the letter of the following standards. The
          ...
          <li>
            ...
            <p>
              ...
              breach of this acceptable use policy through your use of our app.
            ...
            <p>
              ...
              material breach of these terms of use and may result in our taking
          ...
          <li>
            <p>
              ...
              material uploaded by you to our app.
            </p>
          </li>
          <li>
    ...
    <p>
      ...
      use your own virus protection software. You must not misuse our app by
      ...
      You must not attack our app via a denial-of-service attack or a
      ...
      to them. In the event of such a breach, your right to use our app will
      cease immediately.
    </p>
    <p>
      <br />
    </p>
    <h2>Linking to our app</h2>
    <p>
    ...
    <p>
      ...
      must not establish a link to our app in any website that is not owned by
      you. Our app must not be framed on any other app, nor may you create a
      link to any part of our app other than the home page. We reserve the right
      to withdraw linking permission without notice. The website in which you
      are linking must comply in all respects with the content standards set out
    ...
    <p>
      <a href="mailto:Support@joginsurance.com">
        If you wish to make any use of content on our app other than that set
        out above, please contact{' '}
      </a>
      <a href="mailto:Support@joginsurance.com">Support@joginsurance.com.</a>
    </p>
    <p>
      <br />
    </p>
    <h2>Third party links and resources in our app</h2>
    <p>
      Where our app contains links to other sites, apps and resources provided
    ...
    <h2>Changes to the terms of website use policy</h2>
    <p>
      We may revise this terms of website use policy at any time by amending
      this page. You are expected to check this page from time to time to take
      notice of any changes we make, as they are legally binding on you. Some of
      the provisions contained in this terms of website use policy may also be
      superseded by provisions or notices published elsewhere on our app.
    </p>
    <p>
      <br />
    </p>
    <h2>Contact us</h2>
    <p>
      <a href="mailto:support@joginsurance.com">To contact us, please e</a>mail
